<nav class="navbar navbar-expand-lg navbar-light global__transparent menu menu__scroll">
    <div class="container p-sm-0">
        <!-- Logo for desktop -->
        <a class="navbar-brand menu__logo p-0 m-0 d-none d-lg-block" href="index.php">
            <img class="menu__logo-img" src="assets/img/123.png" style="width:100px;" alt="logo">
        </a>
        
        <!-- Heading for mobile -->
        <!-- <h1 class="d-block d-lg-none text-center m-0 fw-bold ms-5" style="font-family: math; padding: left 58px;">HEAL SOCIETY</h1>   -->
        <h1 class="d-block d-lg-none text-center m-0 fw-bold ms-5" style="font-family: math;">
    <a href="index.php" style="text-decoration: none; color: inherit;">HEAL SOCIETY</a>
</h1>
